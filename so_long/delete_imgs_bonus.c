...
/*   Updated: 2022/02/22 16:48:28 by aherrero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_game	delete_images(t_game game)
{
	...
	mlx_destroy_image(game.mlx, game.player.down[1]);
	mlx_destroy_image(game.mlx, game.player.down[2]);
	mlx_destroy_image(game.mlx, game.player.down[3]);
