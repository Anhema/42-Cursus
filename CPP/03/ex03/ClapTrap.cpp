...
/*   Updated: 2022/10/01 14:05:28 by aherrero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name, int hit, int energy, int attack) : name(name), hit_points(hit), energy_points(energy), attack_damage(attack)
{
	std::cout << name << " ClapTrap constructor called" << std::endl;
}
